...
import { PaymentStrategy } from '../../interfaces/payment-strategy/payment-strategy.interface'; // Assuming interface location
import { PaymentApiService } from '../../payment-api/payment-api.service';
import { InitDataRequest } from '../sslcomerz/types/methods.type';
...
export class StripePaymentStrategy implements PaymentStrategy {
  ...
  async validate(data: { session_id: string }): Promise<boolean> {
